...
const layerButtons = document.getElementsByClassName("layer_button"), // music screen
    ...
    musicScreenCheckboxes = document.getElementsByClassName("music_screen_checkboxes"),
    shortcutToggle = document.getElementById("shortcut_toggle"),
    noiseIndicatorToggle = document.getElementById("noise_indicator_toggle"),
